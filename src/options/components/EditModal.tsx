                ...
                <div className="modal__content">
                    <form onSubmit={onSave} className="form">
                        <div className={classNames.formFieldURL}>
                            ...
                            <input id="url" type="text" value={editStylesheet.url} onChange={onEditURL} />
                        ...
                        <div className={classNames.formFieldShortname}>
                            ...
                            <input id="shortname" type="text" placeholder="Choose a shortname for your stylesheet, e.g. My Amazing Theme" value={editStylesheet.shortname} onChange={onEditShortname} />
