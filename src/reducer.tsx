...
type Action = 
    ...
    | { type: "updateState", state: SuperCSSInject, persist: boolean };
...
function setActive (state: State, id: number, tabId: number, persist: boolean): State {
...
function clearActive (state: State, id: number, tabId: number, persist: boolean): State {
    const tabs = { ...state.tabs };
    const url = state.stylesheets[id].url;
